...
class MenFashionList extends StatefulWidget {
  final ValueSetter<dynamic> valueSetter;
  MenFashionList({Key key, this.valueSetter}) : super(key: key);

  @override
  _MenFashionListState createState() => _MenFashionListState();
}

class _MenFashionListState extends State<MenFashionList> {
  Future getMenProduct;
  UserDetailsProvider user = UserDetailsProvider();
  @override
  void initState() {
    super.initState();
    getMenProduct = user.getMenProduct();
  }
