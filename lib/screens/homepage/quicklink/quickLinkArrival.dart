...
class QuickLinkArrival extends StatelessWidget {
  final String slug;
  const QuickLinkArrival({Key key, this.slug}) : super(key: key);
          ...
          builder: (context, value, child) => FutureBuilder(
            ...
            builder: (context, snapshot) {
              ...
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                              ...
                                              child:response[index].image==null?Image.asset(
                ...
                return slug!='market?'?LinearProgressIndicator(minHeight: 2,):Container();
              }
            },
          ),
        ),
